package com.sunshineapp.sunshine.data;
...
public class WeatherProvider extends ContentProvider
{
    ...
    public static UriMatcher buildUriMatcher()
    {
        ...
        /* This URI is content://com.sunshineapp.sunshine/weather/ */
        matcher.addURI(authority, WeatherContract.PATH_WEATHER, CODE_WEATHER);

        /*
         * This URI would look something like content://com.sunshineapp.sunshine/weather/1472214172
            ...
            String[] selectionArgs, String sortOrder)
    {
        ...
        switch (sUriMatcher.match(uri))
        {
             ...
             *
             *      content://com.sunshineapp.sunshine/weather/1472214172
             *
             ...
             *
             *      content://com.sunshineapp.sunshine/weather/
             *
             * sUriMatcher's match method will return the code that indicates to us that we need
